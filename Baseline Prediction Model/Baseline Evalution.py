...
model.load_state_dict(torch.load("/home/SharedStorage2/NewUsersDir/aledhari/npate181/"
                                 "MachineVisionProject/Final_submission/Baseline_Predictions/baseline_model.pth"))
...
print(f"loss: {validate_loss.item()} loss(avg): {np.mean(losses_evaluation)}")
...
plt.savefig("/home/SharedStorage2/NewUsersDir/aledhari/npate181/"
            "MachineVisionProject/Final_submission/Baseline_Predictions/validation_loss.png", format='png')
...
pred_path = '/home/SharedStorage2/NewUsersDir/aledhari/npate181/MachineVisionProject/Final_submission/Baseline_Predictions/submission_baseline.csv'
...
for frame_number in range(99, len(eval_zarr.frames), 1000):  # start from last frame of scene_0 and increase by 100
    ...
    plt2.savefig("/home/SharedStorage2/NewUsersDir/aledhari/npate181"
                 "/MachineVisionProject/Final_submission/Baseline_Predictions/baseline_prediction" + str(frame_number)
                 + ".png", format='png')
